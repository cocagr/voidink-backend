...
public class Tatuador {
    ...
    @Id
    @Column(name = "id")
    private UUID id; // Este ID se sincroniza de forma exacta con auth.users.id de Supabase
    ...
    // Mapeo de la relación intermedia para guardar los estilos en 'tatuadores_estilos'
    @ElementCollection
    @CollectionTable(
    ...
    // Constructor vacío obligatorio requerido por la especificación de JPA
    public Tatuador() {}
    ...
    public List<Long> getEstilos() {
        return estilos;
    }

    public void setEstilos(List<Long> estilos) {
